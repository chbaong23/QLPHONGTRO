                ...
                <div class="menu">
                    <div class="brand-logo">
                        <a href="{{route('trang_chu')}}">
                            <img src="{{asset('assets/images/logo/13.png')}}" style="max-height:100px" alt="" class="img-fluid for-light">
                        ...
                        <div class="main-navbar">
                            <div id="mainnav">
                                ...
                                <ul class="nav-menu">
                                    ...
                                    <li class="">
                                        <a href="{{url($menu->location)}}" class="nav-link menu-title">{{$menu->name}}</a>
                                    </li>
                                    @else
                                    <li class="dropdown">
                                        <a href="#" class="nav-link menu-title">{{$menu->name}}</a>
                                        @include('frontend.components.submenus.lv1',['childs' => $menu->childs])
                                    </li>
                    ...
                    <ul class="header-right">
                        ...
                        <li>
                            <a href="{{route('room_create')}}">Đăng Phòng</i></a>
                        </li>
